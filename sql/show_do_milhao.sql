...
CREATE TABLE IF NOT EXISTS `show_do_milhao`.`Disciplina` (
  ...
  INDEX `fk_Disciplina_Jogo1_idx` (`Jogo_idJogo` ASC),
  CONSTRAINT `fk_Disciplina_Jogo1`
    FOREIGN KEY (`Jogo_idJogo`)
    REFERENCES `show_do_milhao`.`Jogo` (`idJogo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `show_do_milhao`.`Curso` (
  ...
  `Jogo_idJogo` INT NOT NULL,
  PRIMARY KEY (`idCurso`),
  INDEX `fk_Curso_Jogo1_idx` (`Jogo_idJogo` ASC),
  CONSTRAINT `fk_Curso_Jogo1`
    FOREIGN KEY (`Jogo_idJogo`)
    REFERENCES `show_do_milhao`.`Jogo` (`idJogo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `show_do_milhao`.`Assunto` (
  ...
  INDEX `fk_Assunto_Jogo1_idx` (`Jogo_idJogo` ASC),
  CONSTRAINT `fk_Assunto_Jogo1`
    FOREIGN KEY (`Jogo_idJogo`)
    REFERENCES `show_do_milhao`.`Jogo` (`idJogo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
